...
const title = 'JACK OBITO'
const description = 'An AI coding assistant that helps users build projects, debug code, generate UI components, and create full-stack applications directly from prompts.'
